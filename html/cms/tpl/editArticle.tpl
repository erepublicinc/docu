    ...
    <div class="ui-widget-content ui-corner-all bk_color2">
        <!-- MAIN FORM -->
         <form id="id_details_form"  method="post">
            ...
            <input type="hidden" id="id_comment" name='articles_comment' value="{$content->articles_comment}" />
            ...
            <fieldset>                      
                ...
                <div>
                    ...
                    <div class="float-r" style="width: 100px;">
                     ...
                     <br clear="all">                        
                    <textarea id="id_body" type="text" name="articles_body" rows="25" class="required">{$content->articles_body}</textarea>
                </div>   
