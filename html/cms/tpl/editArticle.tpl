...
<!-- CONTENT -->
  <!-- PAGE TITLE -->
    <div class="ui-widget-content ui-corner-all">
        <div class="m-10">  
        <h2>Sacramento, Calif., Police Training Includes Sessions with Local Businesses </h2>
...
*}
    ...
    <div class="ui-widget-content ui-corner-all bk_color3">
        ...
        <h6><a class="ui-state-red ui-corner-all float-r m-5 pr-10 pl-10 pt-5 pb-5" href="#">
        ...
        <div class="m-5 ml-20 float-r">
            Save to: 
            <select name="previewDestID" id="previewDestID" class="select-list-medium" style="width:170px">
                <option class="" value="563137"> LIVE </option>
                <option class="" value="563137"> PREVIEW  </option>
                <option class="" value="563532" selected> DRAFT </option>
            </select> 
        </div>
        <br clear="all">
    </div>
    ...
    <!-- MAIN FORM -->
        <form>
            ...
            <fieldset>                      
                ...
                <div>
                    <label class="grid_12">Page Title:</label>
                    <div class="float-r" style="width: 100px;">
                    <a href="#" class="ui-icon-tan ui-icon-info float-r"></a>                               
                    <span href="#"class="ui-icon ui-icon-stop float-r"></span>
                    </div>                            
                    <input type="text" name="" 
                    value="Sacramento, Calif., Police Training Includes Sessions with Local Businesses ">                                        
                </div>                 
                <div>
                ...
                <div>
                    ...
                    value="{$article->contents_create_date|date_format:$DATETIME_FORMAT}">                                       
                </div>
                <div>
