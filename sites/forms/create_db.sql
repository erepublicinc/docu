-- run this script on the db server with:  mysql --user=root --password=root < create_db.sql 
drop schema forms;
create schema forms;
...
CREATE TABLE forms.fields
    (
        ...
        fields_form_name    VARCHAR(50) NOT NULL,
...
CREATE TABLE forms.field_masters
    (
        fields_title		VARCHAR(100) NOT NULL,
        fields_form_name    VARCHAR(50) NOT NULL,
        fields_tpl			VARCHAR(50),
        ...
        CONSTRAINT form_name_unique UNIQUE (fields_form_name)
        -- PRIMARY KEY (fields_form_name)
    )engine InnoDB;  
...
insert into forms.field_masters (fields_title, fields_form_name, fields_type, fields_validation, fields_required, fields_eloqua_name ) 
...
insert into forms.field_masters (fields_title, fields_form_name, fields_type, fields_validation, fields_required, fields_eloqua_name, fields_values ) 
...
insert into forms.field_masters (fields_title, fields_form_name, fields_type, fields_validation, fields_required, fields_eloqua_name, fields_locked ) 
