...
{foreach $contents as $content}
    {if $content@first && $curPage == 1 && $page->pages_url != '/featured'}
        <div class="featured-hilight">
            ...
            <h3><a href="{$page->pages/url}/{$contents->contents_url_name}.html">{$content->display_title}</a></h3>
    ...
    {else}               
        ...
        <dt class="clear-l">
            ...
            <a class="inline mr-5" href="{$page->pages_url}/{$content->contents_url_name}.html" >
